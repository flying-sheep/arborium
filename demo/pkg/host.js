...
const module0 = getCoreModule('host.core.wasm');
const module1 = getCoreModule('host.core2.wasm');
const module2 = getCoreModule('host.core3.wasm');
const module3 = getCoreModule('host.core4.wasm');
