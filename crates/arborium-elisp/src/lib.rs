...
/// Returns the elisp tree-sitter language.
pub fn language() -> Language {
    unsafe { tree_sitter_elisp() }
}

/// The highlight query for elisp.
pub const HIGHLIGHTS_QUERY: &str = include_str!("../../../grammars/tree-sitter-elisp/queries/highlights.scm");

/// The injections query for elisp (empty - no injections available).
pub const INJECTIONS_QUERY: &str = "";

/// The locals query for elisp (empty - no locals available).
